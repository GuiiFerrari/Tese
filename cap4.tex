...
\begin{figure}[H]
    ...
    \caption{Histograma de comprimento de \textit{track} no eixo $y$ e ângulo de espalhamento no eixo $x$. Pela figura é perceptível que, sem filtros, não é possível notar diferenças entre diferentes trajetórias.}
    \label{fig:comp_vs_ang}
\end{figure}

\par Para entender melhor as diferenças entre as trajetórias de diferentes partículas, o mesmo histograma da figura \ref{fig:comp_vs_ang} foi feito, agora aplicando a condição de que são selecionados apenas eventos com duas trajetórias identificadas e que possuem o mesmo vértice de reação. A figura \ref{fig:coincidencia_detec} mostra o histograma, onde agora é possível notar as características de trajetórias de partículas diferentes.
...
\par Com a figura \ref{fig:coincidencia_detec} é possível perceber as medidas coincidentes do $^{16}$O e do próton. Além disso, o histograma ainda fornece a informação de que os comprimentos das trajetórias dos prótons estão no limite geométrico do detector, pois não há medidas que possuem ângulo de espalhamento maior que 80º e comprimento maior que 150 mm. No caso do $^{16}$O, o ângulo de espalhamento não passa de 45º, porém as trajetórias param no gás, ao contrário do próton.
