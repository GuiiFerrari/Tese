...
\par Para \ref{subfig:exemplos_sinais_1} temos apenas um pulso, o que significa que há um feixe incidindo paralelamente àquele canal do plano detector, afinal, temos apenas um ponto de interação
