...
\par O segundo gate elimina trajetórias originadas de partículas pesadas. O gate está indicado na figura \ref{subfig:gate2_antes}. O resultado, para o espectro de comprimento em função do ângulo de espalhamento, está na figura \ref{subfig:gate2_depois}, onde é possível distinguir dois tipos de trajetórias, uma originada por partículas pesadas ($^{16}$O) e uma por partículas leves (próton).
