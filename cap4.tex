...
\par Para reconstruir a energia das partículas, foi necessário utilizar das propriedades da trajetória e também do poder de freamento (\textit{stopping power}) \cite{DETC_TELE} da partícula no gás. \textit{Cada partícula tem  Stopping power}
