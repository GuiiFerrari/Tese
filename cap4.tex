...
\par Os resultados mostrados na fig \ref{fig:dist_ang} são parciais, porém mostram uma forte dependência da energia do feixe, como já discutido na Ref. \cite{Kolata2016}, onde está discutido o breakup do $^{17}$F em $^{58}$Ni e em $^{208}$Pb \cite{MORO_BREAKUP}.
