...
\par Para identificar essas partículas do coquetel de feixe um sistema de detectores, formando um telescópio DE-Eresidual, foi posicionado .... O espectro biparametrico formado pela combinação dos sinais DE versus Etotal= DE+Eresidual, permite a identificação das partículas. 
