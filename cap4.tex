...
\par A normalização deve ser obtida a partir da análise do canal elástico do experimento. Até o momento da escrita dessa dissertação, o valor da normalização é preliminar e $N_b$ = 7.18$\times$10$^{6}$ part./cm$^2$s.
