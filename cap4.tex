...
\centering
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption{Evento com as detecções sem a correção. As retas de cor amarela e verde são de um único \textit{cluster}.}
...
\par onde $d_{Vr, i}$ é distância entre o ponto $i$ pertencente a trajetória até o vértice de reação $\vec{V_r}$.
