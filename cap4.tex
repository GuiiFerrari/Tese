...
\par Para determinar a energia de reação, é necessário calcular a energia do feixe na posição da reação nuclear. Para isso, o espaço no eixo $z$ foi discretizado, a fim de calcular a energia no momento da reação. O feixe, ao entrar no gás, possui energia inicial $E_i$ = 34.76 MeV, e perde energia ao atravessar o gás. A energia de reação $E_r$ é dada por

\begin{equation}
	E_r = E_i - E_{loss},
\end{equation}

\par onde $E_{loss}$ é a energia perdida pelo feixe até o vértice de reação.
...
\begin{equation}
	\theta = \arccos \left (\vec{V_i} \cdot \vec{V_f} \right),
\end{equation}
