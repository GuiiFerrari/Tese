...
\par Na seção \ref{sec:ml_pc} será mostrado o processo de detecção de trajetórias (\textit{tracking}) com algoritmos de \textit{machine learning}.

%\par Na seção \ref{sec:forcabruta} será mostrado como foram identificadas as trajetórias (também chamado de \textit{tracking}) a partir de estimadores robustos. Na seção , será mostrado como a mesma identificação foi feita a partir de algoritmos de \textit{machine learning}, identificando as diferenças em relação ao método anterior.
